...
class rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_center_freq(1.8425e9, 0)
        ...
        self.uhd_usrp_sink_0.set_center_freq(1.8425e9, 0)
        ...
        # Adding a file sink to save IQ samples
        self.file_sink = blocks.file_sink(gr.sizeof_gr_complex, "test.txt", False)
        self.file_sink.set_unbuffered(False)
        self.connect((self.uhd_usrp_source_0, 0), (self.file_sink, 0))  # Connect USRP source to file sink
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_sink_x_0.set_frequency_range(1.8425e9, self.samp_rate)
